...
add_to_collection(path=path_to_new_db, collection_name='copy_to2', docs=documents_from_db)

first_db = Chroma(persist_directory=path_to_existing_db, collection_name='default', embedding_function=embeddings)
second_db = Chroma(persist_directory=path_to_new_db, collection_name='copy_to2', embedding_function=embeddings)
