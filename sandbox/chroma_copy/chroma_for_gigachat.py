...
path_to_existing_db = normpath(join(dirname(__file__), '..', '..', 'chroma.kb'))
path_to_new_db = normpath(join(dirname(__file__), '..', '..', 'single'))
...
documents_from_db = get_from_collection(path=path_to_existing_db, collection_name='kb.gigaR')
